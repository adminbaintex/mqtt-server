...
[![GoDoc](https://godoc.org/github.com/adminbaintex/gomqtt/packet?status.svg)](http://godoc.org/github.com/adminbaintex/gomqtt/packet)
[![Release](https://img.shields.io/github/release/gomqtt/packet.svg)](https://github.com/adminbaintex/gomqtt/packet/releases)
...
```bash
$ go get github.com/adminbaintex/gomqtt/packet
```
...
More details can be found in the [documentation](http://godoc.org/github.com/adminbaintex/gomqtt/packet).
