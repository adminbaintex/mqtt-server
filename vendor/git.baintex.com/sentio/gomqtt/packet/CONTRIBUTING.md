...
Before creating a new Issue, please check first if a similar Issue [already exists](https://git.baintex.com/sentio/gomqtt/packet/issues?state=open) or was [recently closed](https://git.baintex.com/sentio/gomqtt/packet/issues?direction=desc&page=1&sort=updated&state=closed).
